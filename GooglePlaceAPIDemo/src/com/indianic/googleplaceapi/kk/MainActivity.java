package com.indianic.googleplaceapi.kk;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Users current geo location
         ...
         Log.v("lat point", user_latitude);
         Log.v("long",user_longitude);
	...
	class LoadPlaces extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				// get nearest places
				nearPlaces = googlePlaces.search(Double.parseDouble(user_latitude),
						Double.parseDouble(user_longitude), radius, types);
               Log.v("nearPlaces", nearPlaces.toString());
			} catch (Exception e) {
				e.printStackTrace();
			}
			return null;
